...
![NDVI original output in QGIS](docs/ndvi_qgis_view.png)
![NDVI polished (Singleband PseudoColor with RdYlGn color ramp) output in QGIS](docs/ndvi_qgis_view.png)
